# Generated by Django 3.1.3 on 2020-11-08 22:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auctions', '0003_auto_20201108_1737'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('BOOKS', 'Books'), ('MUSIC', 'Music'), ('GAMES', 'Games'), ('ELECTRONICS', 'Electronics'), ('HOME', 'Home'), ('TOYS', 'Toys'), ('SPORTS', 'Sports')], max_length=200, null=True, verbose_name='Category')),
